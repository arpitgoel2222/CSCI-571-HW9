...
class Child3ViewController: UIViewController, IndicatorInfoProvider {
    ...
    @objc func refresh(sender:AnyObject) {
           AF.request("https://nodeiosapp.wl.r.appspot.com/guardianp")
...
//                                                                                             }
    ...
    extension Child3ViewController: UITableViewDataSource, UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "PoliticsNewsArticle") as! PoliticsNewsArticle
    ...
    //        cell.setitem(article1: video)
            cell.PTitle.text = article1[indexPath.row].title
            cell.PTime.text = article1[indexPath.row].time
            cell.PSection.text = article1[indexPath.row].section
               ...
               if imagedata != nil {
                cell.PImage.image = UIImage(data:imagedata! as Data)
               }
            else{
               cell.PImage.image = UIImage(named: "default-guardian")
            }
