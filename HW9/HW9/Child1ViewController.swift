...
class Child1ViewController: UIViewController, IndicatorInfoProvider {
    ...
    @objc func refresh(sender:AnyObject) {
        AF.request("https://nodeiosapp.wl.r.appspot.com/guardianw")
        ...
        //                                  {
        //                                   finaltime  = (diff[diff.startIndex] * 7 * 24 + components.day! * 24) + components.hour!
        //                                       t1 = String(finaltime) + "h ago"
        //                                  }
        ...
        //                                if(diff.contains("weeks"))
        //                                {
        //                                    finaltime  = Int(components.weeks! * 7 * 24 + components.day! * 24) + components.hour!
        //                                    t1 = String(finaltime) + "h ago"
        //                                }
...
extension Child1ViewController: UITableViewDataSource, UITableViewDelegate{
...
//        }
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "WorldNewsArticle") as! WorldNewsArticle
        ...
        cell.WorldTitle.text = article1[indexPath.row].title
        cell.WorldTime.text = article1[indexPath.row].time
        cell.WorldSection.text = article1[indexPath.row].section
           ...
           if imagedata != nil {
               cell.WorldImage.image = UIImage(data:imagedata! as Data)
           }
           else{
