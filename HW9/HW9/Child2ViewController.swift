...
class Child2ViewController: UIViewController, IndicatorInfoProvider {
    ...
    @objc func refresh(sender:AnyObject) {
           AF.request("https://nodeiosapp.wl.r.appspot.com/guardianb")
...
//                       
    ...
    extension Child2ViewController: UITableViewDataSource, UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "BusinessNewsArticle") as! BusinessNewsArticle
    ...
    //        cell.setitem(article1: video)
            cell.BTitle.text = article1[indexPath.row].title
            cell.BTime.text = article1[indexPath.row].time
            cell.BSection.text = article1[indexPath.row].section
               ...
               if imagedata != nil {
                   cell.BImage.image = UIImage(data:imagedata! as Data)
               }
            else{
                cell.BImage.image = UIImage(named: "default-guardian")
            }
