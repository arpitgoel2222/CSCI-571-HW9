...
class Child4ViewController: UIViewController, IndicatorInfoProvider {
    ...
    @objc func refresh(sender:AnyObject) {
            AF.request("https://nodeiosapp.wl.r.appspot.com/guardians")
...
//                                  }
    ...
    extension Child4ViewController: UITableViewDataSource, UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "SportsNewsArticle") as! SportsNewsArticle
    ...
    //        cell.setitem(article1: video)
            cell.SPTitle.text = article1[indexPath.row].title
            cell.SPTime.text = article1[indexPath.row].time
            cell.SPSection.text = article1[indexPath.row].section
               ...
               if imagedata != nil {
                   cell.SPImage.image = UIImage(data:imagedata! as Data)
               }
            else{
                cell.SPImage.image = UIImage(named: "default-guardian")
            }
