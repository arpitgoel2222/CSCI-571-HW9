...
class Child6ViewController: UIViewController, IndicatorInfoProvider {
       ...
       var refreshControl = UIRefreshControl()
        ...
        @objc func refresh(sender:AnyObject) {
          AF.request("https://nodeiosapp.wl.r.appspot.com/guardiansc")
...
//                                                             }
    ...
    extension Child6ViewController: UITableViewDataSource, UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "ScienceNewsArticle") as! ScienceNewsArticle
    ...
    //        cell.setitem(article1: video)
            cell.SCTitle.text = article1[indexPath.row].title
            cell.SCTime.text = article1[indexPath.row].time
            cell.SCSection.text = article1[indexPath.row].section
               ...
               if imagedata != nil {
                   cell.SCImage.image = UIImage(data:imagedata! as Data)
               }
            else{
                cell.SCImage.image = UIImage(named: "default-guardian")
            }
